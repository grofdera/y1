...
<link rel='stylesheet' id='neve-style-css' href='<?php echo get_template_directory_uri();?>/neve.min.css' type='text/css' media='all' />
...
<body  class="home blog logged-in  nv-blog-grid nv-sidebar-full-width menu_sidebar_slide_left" id="neve_body"  >
...
<div class="site-logo">
	<a class="brand" href="/" title="Cyberpur Docs"
			aria-label="Cyberpur Docs"><div class="nv-title-tagline-wrap"><h1 class="site-title"><?php echo get_bloginfo('name');?></h1><small></small></div></a></div>
